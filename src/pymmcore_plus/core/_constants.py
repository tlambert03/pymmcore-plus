...
class DeviceType(IntEnum):
    UnknownType = pymmcore.DeviceType.UnknownType.value
    AnyType = pymmcore.DeviceType.AnyType.value
    CameraDevice = pymmcore.DeviceType.CameraDevice.value
    ShutterDevice = pymmcore.DeviceType.ShutterDevice.value
    StateDevice = pymmcore.DeviceType.StateDevice.value
    StageDevice = pymmcore.DeviceType.StageDevice.value
    XYStageDevice = pymmcore.DeviceType.XYStageDevice.value
    SerialDevice = pymmcore.DeviceType.SerialDevice.value
    GenericDevice = pymmcore.DeviceType.GenericDevice.value
    AutoFocusDevice = pymmcore.DeviceType.AutoFocusDevice.value
    CoreDevice = pymmcore.DeviceType.CoreDevice.value
    ImageProcessorDevice = pymmcore.DeviceType.ImageProcessorDevice.value
    SignalIODevice = pymmcore.DeviceType.SignalIODevice.value
    MagnifierDevice = pymmcore.DeviceType.MagnifierDevice.value
    SLMDevice = pymmcore.DeviceType.SLMDevice.value
    HubDevice = pymmcore.DeviceType.HubDevice.value
    GalvoDevice = pymmcore.DeviceType.GalvoDevice.value
...
class PropertyType(IntEnum):
    Undef = pymmcore.PropertyType.Undef.value
    String = pymmcore.PropertyType.String.value
    Float = pymmcore.PropertyType.Float.value
    Integer = pymmcore.PropertyType.Integer.value
...
ActionType = pymmcore.ActionType
PortType = pymmcore.PortType
FocusDirection = pymmcore.FocusDirection
DeviceNotification = pymmcore.DeviceNotification
DeviceDetectionStatus = pymmcore.DeviceDetectionStatus
DeviceInitializationState = pymmcore.DeviceInitializationState
